          ...
          <td style="padding-right:36px;padding-left:40px;">
            <table style="font-size:inherit;line-height:inherit;padding:0px;border:0px;">
              <tbody><tr>
               ...
               <tr>
				   <td style="word-break:break-word;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#333;font-size:15px;font-weight:300;line-height:20px;padding-bottom:15px;text-align:left;">ยินดีต้อนรับ คุณ ,
				  </td>
			   </tr>
			   <tr>
             ...
             <p>รหัสในการยืนยันบัญชีของคุณคือ <b></b></p>
             <p>หรือคลิ๊กลิงค์ด้านล่างนี้เพื่อทำการยืนยันอีเมลของคุณ</p>
				     <p>ลิงค์สำหรับการยืนยันอีเมล : <a href="" style="color:rgb(0, 138, 205);text-decoration:none;" target="_blank"></a></p>
				   </td>
			   </tr>
			   <tr>
