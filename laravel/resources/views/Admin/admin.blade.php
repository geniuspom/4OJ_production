...
<style>
.header{
  background-image: url("/4oj/public/tablesorter-master/themes/blue/bg.gif");
...
.headerSortUp{
  background-image: url("/4oj/public/tablesorter-master/themes/blue/asc.gif");
}
.headerSortDown{
  background-image: url("/4oj/public/tablesorter-master/themes/blue/desc.gif");
}
</style>
...
<script type="text/javascript" src="{{$root_url}}/public/tablesorter-master/jquery.tablesorter.js"></script>
