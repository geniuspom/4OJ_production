            ...
            <div class="panel-body">
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="{{ url('/edit_customer') }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="checkbox">
                              <label><input id="tax_address_checkbox" type="checkbox" name="tax_address_checkbox" value="true">ใช้ตามที่อยู่</label>
                        </div>
...
$(document).on('click','#tax_address_checkbox',function(){
  var address = $("textarea[name='address']").val();
  var checkstatus = $("#tax_address_checkbox").prop('checked');

  if(checkstatus == true){
    $("textarea[name='tax_address']").val(address);
  }else{
    $("textarea[name='tax_address']").val('');
  }
