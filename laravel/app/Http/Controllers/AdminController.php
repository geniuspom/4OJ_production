...
Class AdminController extends Controller{
    ...
    public static function admingetuser($filter_group,$filter_value,$sort){
        ...
        echo "<table class='table table-bordered table-hover table-striped' id='admintable'>
                <thead>
                  <tr>
                    <th class='header'>#</th>
                    <th class='header'>ชื่อ - นามสกุล</th>
                    <th class='header'>ชื่อเล่น</th>
                    <th class='no_print header'>อีเมล</th>
                    <th class='header'>โทรศัพท์</th>
                    <th class='header'>เขต</th>
                    <th class='header'>เกรด</th>
                    <th class='header'>ขนาดเสื้อ</th>
                    <th class='header'>remark</th>
                    <th class='header'>สถานะผู้ใช้</th>
                    <th class='no_print header'>ดำเนินการ</th>
                  </tr>
                </thead>
                <tbody>";
