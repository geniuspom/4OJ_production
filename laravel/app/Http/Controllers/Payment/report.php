...
Class report extends Controller{
    ...
    public static function generate_html($data){
      ...
      $returnhtml =   "<form class='form-horizontal' id='payment_form' >
                      ...
                      <th class='text-center'>สถานะการจ่าย</th>
      ...
      if(isset($data)){
          ...
          foreach($data as $record){
            ...
            if($record['pay_status'] == 1){
                ...
                //edit change if pay no show checkbox (30.05.2016)
            ...
            //add more debug no money (30.05.2016)
            if(!empty($record['pay_amt'])){
              $payment_amt = number_format($record['pay_amt']);
            }else{
              $payment_amt = $record['pay_amt'];
            }
