    ...
    if(count($data['inventory_amt']) == 0){
      ...
      for($i = 1; $i <= count($data['inventory_name']);$i++){
          $return_data .= '<tr>
                              ...
                              <td class="text-center r-OJ"></td>
                              <td class="text-center r-sup"></td>
                              <td class="text-center r-cut"></td>
                              <td class="text-center r-receive"></td>
                              <td class="text-center r-return"></td>
      ...
      for($i = 1; $i <= count($data['inventory_name']);$i++){
          $return_data .= '<tr>
                              <td class="text-center">'.$i.'</td>
                              <td>'. $data['inventory_name'][$i]['name'] .'</td>
                              <td class="text-center r-amt">'. ($data['inventory_amt'][$i]['amt_all'] == 0 ? "" : $data['inventory_amt'][$i]['amt_all']) .'</td>
                              <td class="text-center r-OJ">'. ($data['inventory_amt'][$i]['amt_oj'] == 0 ? "" : $data['inventory_amt'][$i]['amt_oj']) .'</td>
                              <td class="text-center r-sup">'. ($data['inventory_amt'][$i]['amt_sup'] == 0 ? "" : $data['inventory_amt'][$i]['amt_sup']) .'</td>
                              <td class="text-center r-cut">'. ($data['inventory_amt'][$i]['amt_cus'] == 0 ? "" : $data['inventory_amt'][$i]['amt_cus']) .'</td>
                              <td class="text-center r-receive">'. ($data['inventory_amt'][$i]['amt_receive'] == 0 ? "" : $data['inventory_amt'][$i]['amt_receive']) .'</td>
                              <td class="text-center r-return">'. ($data['inventory_amt'][$i]['amt_return'] == 0 ? "" : $data['inventory_amt'][$i]['amt_return']) .'</td>
                              <td>'. $data['inventory_name'][$i]['remark'] .'</td>
                          </tr>';
      }
